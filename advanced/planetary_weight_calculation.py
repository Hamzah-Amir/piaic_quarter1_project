...
def weight():
    ...
    try:
        ...
        if other_planet_weight == "Mars":
            ...
            print(f"According to NASA calculation your weight on Mercury will be: {round(weight_earth*0.378,2)}")
        
        elif other_planet_weight == "Venus":
            print(f"According to NASA calculation your weight on Venus will be: {round(weight_earth*0.889,2)}")
        
        elif other_planet_weight == "Jupiter":
            print(f"According to NASA calculation your weight on Jupiter will be: {round(weight_earth*2.36,2)}")
        
        elif other_planet_weight == "Saturn":
            print(f"According to NASA calculation your weight on Saturn will be: {round(weight_earth*1.081,2)}")
        
        elif other_planet_weight == "Uranus":
            print(f"According to NASA calculation your weight on Uranus will be: {round(weight_earth*0.815,2)}")
        
        elif other_planet_weight == "Neptune":
            print(f"According to NASA calculation your weight on Neptune will be: {round(weight_earth*1.14,2)}")
